...
def write_csv(data):
    with open('output/rasa_test_report.csv', 'w') as csvFile:
        fields = ['actual', 'dialogflow', 'rasa', 'score', "suggestion", "text"]
...
if __name__ == "__main__":
    directory_json = "json/rasa_parse.json"
